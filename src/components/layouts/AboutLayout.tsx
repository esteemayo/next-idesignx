...
const Container = styled.main`
  ...
  @media only screen and (max-width: 25em) {
    grid-template-rows: 70vw min-content 57vw min-content 45vw min-content;
  }

  @media only screen and (max-width: 22.5em) {
    grid-template-rows: 73vw min-content 57vw min-content 48vw min-content;
  }

  @media only screen and (max-width: 21.5em) {
    grid-template-rows: 75vw min-content 57vw min-content 50vw min-content;
  }

  @media only screen and (max-width: 18.75em) {
    grid-template-rows: 78vw min-content 57vw min-content 53vw min-content;
  }

  @media only screen and (max-width: 17.5em) {
    grid-template-rows: 80vw min-content 57vw min-content 57vw min-content;
  }
